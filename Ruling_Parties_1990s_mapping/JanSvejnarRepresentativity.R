...
World_Pop_His <- read_csv("/Users/henry/Desktop/SEMESTER 2/Digital Arkiv og Metode/Final Project/Ruling_Parties_1990s_mapping/Data/population-and-demography.csv")
