...
Yugo_GDP <- read_csv("/Users/henry/Desktop/SEMESTER 2/Digital Arkiv og Metode/Final Project/Ruling_Parties_1990s_mapping/Data/gdp-maddison-project-database.csv")
